...
class TestOpenClawTLI(unittest.TestCase):

    def setUp(self):
        self.script_path = "./openclaw-tli"

    def test_executable_exists(self):
        self.assertTrue(os.path.exists(self.script_path), "openclaw-tli executable should exist")
        self.assertTrue(os.access(self.script_path, os.X_OK), "openclaw-tli should be executable")
    ...
    def test_help_command(self):
        ...
        self.assertIn("TLI Tool", res.stdout, "help output should show TLI Tool title")
    ...
    def test_dynamic_import_helpers(self):
        ...
        loader = SourceFileLoader("openclaw_tli", self.script_path)
